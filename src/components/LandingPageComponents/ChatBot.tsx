...
// import avatar from '../../assets/avatar.png'; // make sure this exists or use any online avatar
...
//   return (
//     <div className="fixed bottom-[90px] right-[5%] w-[380px] bg-white border border-gray-300 rounded-xl shadow-2xl z-[999999] flex flex-col overflow-hidden">
//       {/* Header */}
//       <div className="bg-[var(--primary-color)] text-white p-2 relative rounded-t-xl">
//         <div>
//           <h2 className="font-semibold text-base">Sam</h2>
//           <span className="text-xs font-light">AI Assistant</span>
//         </div>
//         <img
//           src={avatar}
//           alt="Sam"
//           className="absolute top-2 right-3 w-10 h-10 rounded-full border-2 border-white object-cover"
//         />
//       </div>
...
//                 {msg.sender === 'user' ? `You at ${msg.time}` : `Chat Bot at ${msg.time}`}
//               </span>
//             </div>
//           </div>
//         ))}
...
//           className="flex-1 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-full py-2 px-2 transition-all"
//         >
//           🗓️ Get a Demo
//         </button>
//         <button
