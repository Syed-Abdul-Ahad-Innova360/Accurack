  ...
  return (
    <div className="flex flex-col items-center justify-center mt-20 md:mt-40 lg:mt-40">
        ...
        <div className="relative mt-10 flex flex-col md:flex-row lg:flex-row md:gap-10 lg:gap-10 items-center justify-center md:w-[50vw] lg:w-[50vw]">
            <img src="/pentagonPhone.png" className="md:hidden size-1/2 lg:hidden mb-20" alt="pentagon" />
            <img src="/inventory.png" className="md:h-[70vh] lg:h-[70vh]" alt="picture" />
            {/* hidden on phone */}
            <img src="/pentagonPc.png" className="hidden md:bolck lg:block h-[70vh] ml-40" alt="pentagon" />
        </div>
    </div>
  )
}
