...
function Hero() {
  return (
    <div className='flex w-full overflow-hidden flex-col md:flex-row lg:flex-row h-max justify-center bg-[linear-gradient(0deg,_#ffffff_30%,_var(--header-color)_100%)]'>
      {/* left side */}
